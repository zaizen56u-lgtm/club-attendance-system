...
io.on('connection', (socket) => {
  ...
  socket.on('overridePastAttendance', (data, callback) => {
    ...
    const tStartISO = new Date(`${targetDate}T${effectiveStartTime ? effectiveStartTime + ":00" : defaultStart}+09:00`).toISOString();
    const tEndISO = new Date(`${targetDate}T${customEndTimeStr ? customEndTimeStr + ":00" : defaultEnd}+09:00`).toISOString();
