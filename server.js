...
io.on('connection', (socket) => {
  ...
  socket.on('overridePastAttendance', (data, callback) => {
    const { password, memberId, targetDate, newStatus, customStartTimeStr, customEndTimeStr } = data;
    ...
    const tStartISO = new Date(`${targetDate}T${customStartTimeStr ? customStartTimeStr + ":00" : defaultStart}+09:00`).toISOString();
