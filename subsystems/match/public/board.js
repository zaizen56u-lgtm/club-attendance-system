...
setInterval(async () => {
    try {
        ...
        document.getElementById('main-timer').innerText = formatTime(displayTime);
        
        const settingLabel = document.getElementById('setting-time-label');
        if (settingLabel) {
        ...
        const formattedLeft = formatTeamName(state.nameLeft);
        if (nameL.innerText !== formattedLeft) {
            nameL.innerText = formattedLeft;
            updateFontSize(nameL);
        }
        
        const formattedRight = formatTeamName(state.nameRight);
        if (nameR.innerText !== formattedRight) {
            nameR.innerText = formattedRight;
